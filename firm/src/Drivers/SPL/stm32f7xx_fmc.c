...
/* Includes ------------------------------------------------------------------*/
#include "../include/stm32f7xx_fmc.h"
...
void FMC_NORSRAMInit(FMC_NORSRAMInitTypeDef* FMC_NORSRAMInitStruct)
{
  ...
  assert_param(IS_FMC_WRITE_FIFO(FMC_NORSRAMInitStruct->FMC_WriteFifo));
  assert_param(IS_FMC_PAGESIZE(FMC_NORSRAMInitStruct->FMC_PageSize));
  ...
  FMC_Bank1->BTCR[FMC_NORSRAMInitStruct->FMC_Bank] =   
            ...
            FMC_NORSRAMInitStruct->FMC_WriteFifo |
            FMC_NORSRAMInitStruct->FMC_PageSize;
  ...
  if(FMC_NORSRAMInitStruct->FMC_Bank != FMC_Bank1_NORSRAM1)
  {
    FMC_Bank1->BTCR[FMC_Bank1_NORSRAM1] |= (uint32_t)(FMC_NORSRAMInitStruct->FMC_WriteFifo);              
  }
...
{  
  ...
  FMC_NORSRAMInitStruct->FMC_WriteFifo = FMC_WriteFifo_Disable;
  FMC_NORSRAMInitStruct->FMC_PageSize = FMC_PageSize_None;
