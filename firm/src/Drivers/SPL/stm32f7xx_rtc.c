...
/* Includes ------------------------------------------------------------------*/
#include "../include/stm32f7xx_rtc.h"
...
#define RTC_FLAGS_MASK          ((uint32_t)(RTC_FLAG_TSOVF | RTC_FLAG_TSF | RTC_FLAG_WUTF | \
                                            ...
                                            RTC_FLAG_RECALPF | RTC_FLAG_SHPF | RTC_FLAG_TAMP3F | \
                                            RTC_FLAG_TAMP2F | RTC_FLAG_ITSF))
...
void RTC_TamperTriggerConfig(uint32_t RTC_Tamper, uint32_t RTC_TamperTrigger)
{
  ...
  {  
    ...
    RTC->TAMPCR &= (uint32_t)((uint32_t)~(RTC_Tamper << 1));	
  }
  else
  { 
    /* Configure the RTC_TAFCR register */
    RTC->TAMPCR |= (uint32_t)(RTC_Tamper << 1);  
  }  
}
...
void RTC_TamperCmd(uint32_t RTC_Tamper, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    RTC->TAMPCR |= (uint32_t)RTC_Tamper;
  }
  else
  {
...
void RTC_TamperFilterConfig(uint32_t RTC_TamperFilter)
{
  ...
  RTC->TAMPCR &= (uint32_t)~(RTC_TAMPCR_TAMPFLT);

  /* Configure the RTC_TAFCR register */
  RTC->TAMPCR |= (uint32_t)RTC_TamperFilter;
}
...
void RTC_TamperSamplingFreqConfig(uint32_t RTC_TamperSamplingFreq)
{
  ...
  RTC->TAMPCR &= (uint32_t)~(RTC_TAMPCR_TAMPFREQ);

  /* Configure the RTC_TAFCR register */
  RTC->TAMPCR |= (uint32_t)RTC_TamperSamplingFreq;
}
...
void RTC_TamperPinsPrechargeDuration(uint32_t RTC_TamperPrechargeDuration)
{
  ...
  RTC->TAMPCR &= (uint32_t)~(RTC_TAMPCR_TAMPPRCH);

  /* Configure the RTC_TAFCR register */
  RTC->TAMPCR |= (uint32_t)RTC_TamperPrechargeDuration;
}
...
void RTC_TimeStampOnTamperDetectionCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    RTC->TAMPCR |= (uint32_t)RTC_TAMPCR_TAMPTS;
  }
  else
  {
 ...
 if (NewState != DISABLE)
  {
    ...
    RTC->TAMPCR &= (uint32_t)~RTC_TAMPCR_TAMPPUDIS; 
  }
  else
  {
...
void RTC_TimeStampPinSelection(uint32_t RTC_TimeStampPin)
{
  ...
  RTC->OR &= (uint32_t)~(RTC_OR_TSINSEL);
  RTC->OR |= (uint32_t)(RTC_TimeStampPin);  
}
...
void RTC_OutputTypeConfig(uint32_t RTC_OutputType)
{
  ...
  RTC->OR &= (uint32_t)~(RTC_OR_ALARMTYPE);
  RTC->OR |= (uint32_t)(RTC_OutputType);  
}
...
void RTC_ITConfig(uint32_t RTC_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    RTC->CR |= (uint32_t)(RTC_IT & ~RTC_TAMPCR_TAMPIE);
    /* Configure the Tamper Interrupt in the RTC_TAFCR */
    RTC->TAMPCR |= (uint32_t)(RTC_IT & RTC_TAMPCR_TAMPIE);
  }
  else
  {
    /* Configure the Interrupts in the RTC_CR register */
    RTC->CR &= (uint32_t)~(RTC_IT & (uint32_t)~RTC_TAMPCR_TAMPIE);
    /* Configure the Tamper Interrupt in the RTC_TAFCR */
    RTC->TAMPCR &= (uint32_t)~(RTC_IT & RTC_TAMPCR_TAMPIE);
  }
  /* Enable the write protection for RTC registers */
...
/**
  ...
  *            @arg RTC_FLAG_ITSF: Internal Time Stamp event flags.
...
/**
  ...
  *            @arg RTC_IT_TAMP3: Tamper 3 event interrupt 
...
ITStatus RTC_GetITStatus(uint32_t RTC_IT)
{
  ...
  tmpreg = (uint32_t)(RTC->TAMPCR & (RTC_TAMPCR_TAMPIE));
