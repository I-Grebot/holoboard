/* Includes ------------------------------------------------------------------*/
#include "../include/stm32f7xx_usart.h"
...
/**
  ...
  * @param  USARTx/UARTy: where x can be 1, 2, 3 or 6 to select the USART peripheral.
  *                       where y can be 4, 5, 7 or 8 to select the USART peripheral.
  * @retval None
  */
void USART_DeInit(USART_TypeDef* USARTx)
{
  ...
  {
    RCC_APB1PeriphResetCmd(RCC_APB2Periph_USART6, ENABLE);
    RCC_APB1PeriphResetCmd(RCC_APB2Periph_USART6, DISABLE);
  }
...
/**
  ...
  * @param  USARTx/UARTy: where x can be 1, 2, 3 or 6 to select the USART peripheral.
  *                       where y can be 4, 5, 7 or 8 to select the USART peripheral.
  * @retval        USART_CLOCKSOURCE_PCLK1:     USARTx use PCLK1 clock source
  *                USART_CLOCKSOURCE_PCLK2:     USARTx use PCLK2 clock source
  *                USART_CLOCKSOURCE_HSI:       USARTx use HSI clock source
...
void USART_ClockInit(USART_TypeDef* USARTx, USART_ClockInitTypeDef* USART_ClockInitStruct)
{
  uint32_t tmpreg = 0;
  /* Check the parameters */
  assert_param(IS_USART_PERIPH(USARTx));
