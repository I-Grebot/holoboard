...
#ifndef __STM32F7xx_CRYP_H
#define __STM32F7xx_CRYP_H
...
#define CRYP_DataType_16b         ((uint32_t)CRYP_CR_DATATYPE_0)
#define CRYP_DataType_8b          ((uint32_t)CRYP_CR_DATATYPE_1)
#define CRYP_DataType_1b          ((uint32_t)CRYP_CR_DATATYPE)
...
#define CRYP_KeySize_192b         ((uint32_t)CRYP_CR_KEYSIZE_0)
#define CRYP_KeySize_256b         ((uint32_t)CRYP_CR_KEYSIZE_1)
