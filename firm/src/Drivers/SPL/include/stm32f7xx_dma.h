...
#ifndef __STM32F7xx_DMA_H
#define __STM32F7xx_DMA_H
...
#define DMA_DIR_MemoryToPeripheral        ((uint32_t)DMA_SxCR_DIR_0) 
#define DMA_DIR_MemoryToMemory            ((uint32_t)DMA_SxCR_DIR_1)
...
/** @defgroup DMA_peripheral_incremented_mode 
  * @{
  */ 
#define DMA_PeripheralInc_Enable          ((uint32_t)DMA_SxCR_PINC)
...
/** @defgroup DMA_memory_incremented_mode 
  * @{
  */ 
#define DMA_MemoryInc_Enable              ((uint32_t)DMA_SxCR_MINC)
...
#define DMA_PeripheralDataSize_HalfWord   ((uint32_t)DMA_SxCR_PSIZE_0) 
#define DMA_PeripheralDataSize_Word       ((uint32_t)DMA_SxCR_PSIZE_1)
...
#define DMA_MemoryDataSize_HalfWord       ((uint32_t)DMA_SxCR_MSIZE_0) 
#define DMA_MemoryDataSize_Word           ((uint32_t)DMA_SxCR_MSIZE_1)
...
/** @defgroup DMA_circular_normal_mode 
  * @{
  */ 
#define DMA_Mode_Normal                   ((uint32_t)0x00000000)       /*!< Normal mode                  */
#define DMA_Mode_Circular                 ((uint32_t)DMA_SxCR_CIRC)    /*!< Circular mode                */
...
#define DMA_Priority_VeryHigh             ((uint32_t)DMA_SxCR_PL)
...
#define DMA_FIFOThreshold_HalfFull        ((uint32_t)DMA_SxFCR_FTH_0) 
#define DMA_FIFOThreshold_3QuartersFull   ((uint32_t)DMA_SxFCR_FTH_1)
#define DMA_FIFOThreshold_Full            ((uint32_t)DMA_SxFCR_FTH)
...
#define DMA_MemoryBurst_INC4              ((uint32_t)DMA_SxCR_MBURST_0)  
#define DMA_MemoryBurst_INC8              ((uint32_t)DMA_SxCR_MBURST_1)
#define DMA_MemoryBurst_INC16             ((uint32_t)DMA_SxCR_MBURST)
...
#define DMA_PeripheralBurst_INC4          ((uint32_t)DMA_SxCR_PBURST_0)  
#define DMA_PeripheralBurst_INC8          ((uint32_t)DMA_SxCR_PBURST_1)
#define DMA_PeripheralBurst_INC16         ((uint32_t)DMA_SxCR_PBURST)
...
#define DMA_PINCOS_WordAligned            ((uint32_t)DMA_SxCR_PINCOS)
...
#define DMA_FlowCtrl_Peripheral           ((uint32_t)DMA_SxCR_PFCTRL)
