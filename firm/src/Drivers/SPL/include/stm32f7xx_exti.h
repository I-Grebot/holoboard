...
#ifndef __STM32F7xx_EXTI_H
#define __STM32F7xx_EXTI_H
...
#define EXTI_Line23      ((uint32_t)0x00800000)  /*!< External interrupt line 23 Connected to ??? */
