...
#ifndef __STM32F7xx_SAI_H
#define __STM32F7xx_SAI_H
...
#define SAI_Mode_MasterRx               ((uint32_t)SAI_xCR1_MODE_0)  
#define SAI_Mode_SlaveTx                ((uint32_t)SAI_xCR1_MODE_1)
#define SAI_Mode_SlaveRx                ((uint32_t)SAI_xCR1_MODE)
...
#define SAI_DataSize_8b                   ((uint32_t)SAI_xCR1_DS_1)
#define SAI_DataSize_10b                  ((uint32_t)(SAI_xCR1_DS_1 | SAI_xCR1_DS_0))
#define SAI_DataSize_16b                  ((uint32_t)SAI_xCR1_DS_2)
#define SAI_DataSize_20b                  ((uint32_t)(SAI_xCR1_DS_2 | SAI_xCR1_DS_0))
#define SAI_DataSize_24b                  ((uint32_t)(SAI_xCR1_DS_2 | SAI_xCR1_DS_1))
#define SAI_DataSize_32b                  ((uint32_t)SAI_xCR1_DS)
...
#define SAI_SlotActive_ALL           ((uint32_t)SAI_xSLOTR_SLOTEN)
