...
#ifndef __STM32F7XX_CEC_H
#define __STM32F7XX_CEC_H
...
#define CEC_LongBitPeriodError_On       CEC_CFGR_LBPEGEN         /*!< Long Bit Period Error generation turned On  */
