...
#ifndef __STM32F7xx_FMC_H
#define __STM32F7xx_FMC_H
...
typedef struct
{
  ...
  uint32_t FMC_WriteFifo;            /*!< Enables or disables the write FIFO used by the FMC controller.
                                          This parameter is only enabled through the FMC_BCR1 register, and don't care 
                                          through FMC_BCR2..4 registers.
                                          This parameter can be a value of @ref FMC_Write_FIFO */

  uint32_t FMC_PageSize;             /*!< Specifies the memory page size.
...
#define IS_FMC_NAND_BANK(BANK) (((BANK) == FMC_Bank3_NAND))
/**
  * @}
  */
...
/** @defgroup FMC_Write_FIFO FMC Write FIFO 
  * @{
  */
#define FMC_WriteFifo_Disable           ((uint32_t)0x00000000)
#define FMC_WriteFifo_Enable            ((uint32_t)FMC_BCR1_WFDIS)

#define IS_FMC_WRITE_FIFO(__FIFO__) (((__FIFO__) == FMC_WriteFifo_Disable) || \
                                     ((__FIFO__) == FMC_WriteFifo_Enable))
/**
  * @}
  */
...
/** @defgroup FMC_Page_Size FMC Page Size
  * @{
  */
#define FMC_PageSize_None           ((uint32_t)0x00000000)
#define FMC_PageSize_128            ((uint32_t)FMC_BCR1_CPSIZE_0)
#define FMC_PageSize_256            ((uint32_t)FMC_BCR1_CPSIZE_1)
#define FMC_PageSize_1024           ((uint32_t)FMC_BCR1_CPSIZE_2)

#define IS_FMC_PAGESIZE(__SIZE__) (((__SIZE__) == FMC_PageSize_None) || \
                                   ((__SIZE__) == FMC_PageSize_128) || \
                                   ((__SIZE__) == FMC_PageSize_256) || \
                                   ((__SIZE__) == FMC_PageSize_1024))
/**
  * @}
  */  
...
/** @defgroup FMC_Command_Target
  * @{
  */
#define FMC_Command_Target_bank2           ((uint32_t)FMC_SDCMR_CTB2)
#define FMC_Command_Target_bank1           ((uint32_t)FMC_SDCMR_CTB1)
...
/** @defgroup FMC_Interrupt_sources 
  * @{
  */
#define FMC_IT_RisingEdge                       ((uint32_t)FMC_SR_IREN)
#define FMC_IT_Level                            ((uint32_t)FMC_SR_ILEN)
#define FMC_IT_FallingEdge                      ((uint32_t)FMC_SR_IFEN)
#define FMC_IT_Refresh                          ((uint32_t)FMC_SDRTR_REIE)
...
#define IS_FMC_IT_BANK(BANK) (((BANK) == FMC_Bank3_NAND)   || \
...
/** @defgroup FMC_Flags 
  * @{
  */
#define FMC_FLAG_RisingEdge                     ((uint32_t)FMC_SR_IRS)
#define FMC_FLAG_Level                          ((uint32_t)FMC_SR_ILS)
#define FMC_FLAG_FallingEdge                    ((uint32_t)FMC_SR_IFS)
...
#define IS_FMC_GETFLAG_BANK(BANK) (((BANK) == FMC_Bank3_NAND)    || \
                                   ((BANK) == FMC_Bank1_SDRAM)   || \
                                   ((BANK) == FMC_Bank2_SDRAM)   || \
