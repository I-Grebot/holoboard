...
#define IS_RTC_TAMPER(TAMPER) (((TAMPER) == RTC_Tamper_1) || ((TAMPER) == RTC_Tamper_2) || ((TAMPER) == RTC_Tamper_3))
...
#define RTC_OutputType_PushPull            ((uint32_t)RTC_OR_ALARMTYPE)
...
#define IS_RTC_GET_FLAG(FLAG) (((FLAG) == RTC_FLAG_TSOVF) || ((FLAG) == RTC_FLAG_TSF) || \
                               ...
                               ((FLAG) == RTC_FLAG_SHPF) || ((FLAG) == RTC_FLAG_ITSF))
#define IS_RTC_CLEAR_FLAG(FLAG) (((FLAG) != (uint32_t)RESET) && (((FLAG) & 0xFFFD00DF) == (uint32_t)RESET))
/**
  * @}
  */ 
